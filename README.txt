...
(number)_(assignment name)

This is assuming there is only homework once a week.


Each package will typically have a README unless it is not needed or the code is self explanitory.